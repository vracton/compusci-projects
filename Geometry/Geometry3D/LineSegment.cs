...
namespace Geometry.Geometry3D
{
    ...
    public class LineSegment(Point p1, Point p2)
    {
        ...
        /// <summary>
        /// Finds the distance squared (for efficiency) from this segment to an external point
        /// </summary>
        ...
        {
            return line.DistanceSquared(NearestPoint(line));
        }

        public double DistanceSquared(Ray ray)
        {
            return ray.DistanceSquared(NearestPoint(ray));
        }

        public double DistanceSquared(LineSegment segment)
        {
            return segment.DistanceSquared(NearestPoint(segment));
        }
